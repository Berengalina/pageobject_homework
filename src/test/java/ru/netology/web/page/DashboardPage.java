...
public class DashboardPage {
    ...
    private SelenideElement headingCabinet = $("[data-test-id=dashboard]");
    private SelenideElement headingCards = $(byText("Ваши карты"));
    ...
    public DashboardPage(){
        headingCards.shouldBe(Condition.visible);
    }
